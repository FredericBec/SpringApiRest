...
public class TestRepository
{
    ...
    void dbbAdd()
    {
        ...
        trainingRepository.save(new Training(null , "Java" , "back" , 10 , 1 , false,true , 10 ,null , cat2));
        trainingRepository.save(new Training(null , "javascript" , "front" , 20 , 1 , false,true , 10 ,null , cat1));
        trainingRepository.save(new Training(null , "php" , "back" , 30 , 1 , false,true , 10 ,null , cat2));
    }
