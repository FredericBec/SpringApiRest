...
class TestTrainingService
{
    ...
    void dbbAdd()
    {
        ...
        train1 = new Training(null , "Java" , "back" , 10 , 1 , false,true , 10 ,null , cat2 );
        train2 = new Training(null , "javascript" , "front" , 20 , 1 , false,true , 10 ,null , cat1 );
        train3 = new Training(null , "php" , "back" , 30 , 1 , false,true , 10 ,null , cat3 );
    }
