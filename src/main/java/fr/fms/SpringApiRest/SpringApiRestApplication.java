...
public class SpringApiRestApplication implements CommandLineRunner {
	...
	private void generateData()
	{
		...
		trainingRepository.save(new Training(null, "PowerBi", "Business Intelligence 5 jours", 3000.0, 1, "default.png" , logiciel));
		...
		trainingRepository.save(new Training(null, "Rust", "DotNet & entityframework en 5 jours", 2150.0, 1,  "default.png" , logiciel));
		trainingRepository.save(new Training(null, "Swift", "Business Intelligence 5 jours", 3010.0, 1, "swift.png"  , logiciel));
		trainingRepository.save(new Training(null, "API", "Prise en main de NodeJs/Express 2 jours", 1420.0, 1, "default.png"  , Cybersecu));
		trainingRepository.save(new Training(null, "Spring", "Initiation au Dev/Web avec hp 4 jours", 1350.0, 1, "default.png"   , Cybersecu));
	}
}
